...
kernel: ## Jupyter Kernel registrieren
	. .venv/bin/activate && python -m ipykernel install --user --name telefonica_churn --display-name "Python (telefonica_churn)"
	@echo "✅ Kernel 'telefonica_churn' registriert."
